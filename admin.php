...
<body class="">
	<section class="vbox">
		<header class=" dk header navbar navbar-fixed-top-xs" style="background:#762778;">
			<div class="navbar-header aside-md">
				<a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen,open" data-target="#nav,html"> <i class="fa fa-bars"></i> </a>
				<a href="#" class="navbar-brand" data-toggle="fullscreen" style="color:white;">Optica Nueva</a>
