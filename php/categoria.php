<section class="panel panel-default pos-rlt clearfix">
	...
	<header class="panel-heading"> <i class="fa fa-wrench"></i> Categoria</header>
	
	<div class="row wrapper">
		<div class="col-sm-9 m-b-xs">
			<a href="admin.php?m=categoriaAgregar" class="pull-left btn btn-sm btn-success"><i class="fa fa-plus"></i> Agregar Categoria</a>
		</div>
		<div class="col-sm-3">
...
<?php
			...
			if ( isset($_GET['del']) ){
				...
				mysql_query("DELETE FROM categoria WHERE idcategoria='".$del."'");
			}
			...
			if ( isset($_GET['buscar']) ){
				...
				$consulta  = "SELECT * FROM categoria WHERE 
					(nombre LIKE '%".$buscar."%') 
					ORDER BY nombre ASC"; 
					$url = "admin.php?m=categoria&buscar=".$buscar;
			} else {
				$consulta  = "SELECT * FROM categoria ORDER BY nombre ASC";
				$url = "admin.php?m=categoria";
			}
...
?>
					...
					<td>
						<a href="admin.php?m=categoriaEditar&id=<?php echo $q->idcategoria; ?>" class="btn btn-sm btn-default"> <i class="fa fa-pencil"></i> </a> &nbsp;
						<a href="admin.php?m=categoria&del=<?php echo $q->idcategoria; ?>" class="btn btn-sm btn-danger"> <i class="fa fa-times"></i> </a>					
					</td>
				</tr>
<?php
			}
